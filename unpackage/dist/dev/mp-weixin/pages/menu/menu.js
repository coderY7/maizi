...
var _menu = _interopRequireDefault(__webpack_require__(/*! ./pages/menu/menu.vue */ 52));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...

{
  ...
  methods: {
    ...
    swichMenu: function swichMenu(index) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
                ...
                if (index == '1') {
                  ...
                  _this2.$u.api.caterings({
                    ...
                    fdbh: _this2.fdbh,
                    companyid: _this2.companyid,
                    categoryid: _this2.categorylist[1].category_id }).
                  then(function (res) {
                    console.log(res);
                    _this2.disheslist = res.disheslist;
                  });
                ...
                if (index == '2') {
                  ...
                  _this2.$u.api.caterings({
                    ...
                    fdbh: _this2.fdbh,
                    companyid: _this2.companyid,
                    categoryid: _this2.categorylist[2].category_id }).
                  then(function (res) {
                    console.log(res);
                    _this2.disheslist = res.disheslist;
                  });
                ...
                if (index == '3') {
                  ...
                  _this2.$u.api.caterings({
                    ...
                    fdbh: _this2.fdbh,
                    companyid: _this2.companyid,
                    categoryid: _this2.categorylist[3].category_id }).
                  then(function (res) {
                    console.log(res);
                    _this2.disheslist = res.disheslist;
                  });
                ...
                if (index == '4') {
                  ...
                  _this2.$u.api.caterings({
                    ...
                    fdbh: _this2.fdbh,
                    companyid: _this2.companyid,
                    categoryid: _this2.categorylist[4].category_id }).
                  then(function (res) {
                    console.log(res);
                    _this2.disheslist = res.disheslist;
                  });
                ...
                if (index == '5') {
                  ...
                  _this2.$u.api.caterings({
                    ...
                    fdbh: _this2.fdbh,
                    companyid: _this2.companyid,
                    categoryid: _this2.categorylist[5].category_id }).
                  then(function (res) {
                    console.log(res);
                    _this2.disheslist = res.disheslist;
                  });
    ...
    handleMenuSelected: function handleMenuSelected(id) {var _this9 = this;
      this.productsScrollTop = this.categories.find(function (item) {return item.id == id;}).top;
      this.$nextTick(function () {return _this9.currentCategoryId = id;});
    },
