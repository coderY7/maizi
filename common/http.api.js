...
let defend='/cateing/tablemanage/defend'
...
const install = (Vue, vm) => {
    ...
    vm.$u.api = {defend,manages,exts,searchs,paydones,userchecks,logins,categorys,caterings,dishess,orders,readytopays,pays,querys,backs};
}
